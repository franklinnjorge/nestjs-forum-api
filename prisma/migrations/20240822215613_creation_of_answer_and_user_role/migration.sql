...
*/
-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMINSTRATION', 'STUDENT');
...
-- AddForeignKey
ALTER TABLE "answers" ADD CONSTRAINT "answers_quiestion_id_fkey" FOREIGN KEY ("quiestion_id") REFERENCES "questions"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
